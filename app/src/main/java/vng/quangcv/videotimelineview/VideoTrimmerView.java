...
import vng.quangcv.videotimelineview.interfaces.OnProgressVideoListener;
import vng.quangcv.videotimelineview.interfaces.OnRangeSeekBarListener;
import vng.quangcv.videotimelineview.utils.DeviceUtil;
import vng.quangcv.videotimelineview.utils.UiThreadExecutor;
import vng.quangcv.videotimelineview.utils.UnitConverter;
import vng.quangcv.videotimelineview.widget.RangeSeekBarView;
import vng.quangcv.videotimelineview.widget.Thumb;
import vng.quangcv.videotimelineview.widget.VideoThumbHorizontalListView;
...
public class VideoTrimmerView extends FrameLayout {
    ...
    public void setVideoURI(final Uri videoURI) {
        ...
        try {
            ...
            mediaMetadataRetriever.setDataSource(mContext, mSrc);
            ...
            for (long i = 0; i < numThumbs; ++i) {
                ...
                if (thumbnailList.size() == 3) {
                    videoThumbAdapter.addAll((ArrayList<Bitmap>) thumbnailList.clone());
